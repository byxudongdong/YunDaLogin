...
import com.Mainmenulist.Mainlist;
...
public class Fajian extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fajian);
        lv = (ListView)this.findViewById(R.id.fajian_list);
        //获取将要绑定的数据设置到data中
        data = getdbData();
        adapter = new MyAdapter(this);
        lv.setAdapter(adapter);

        fajian_back = (Button) findViewById(R.id.fajian_back);
        ...
        lv.setOnItemClickListener(new OnItemClickListener(){
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //Toast显示测试
                Toast.makeText(Fajian.this, "信息ID:"+ position + infoTitle, Toast.LENGTH_SHORT).show();
                switch ( Integer.parseInt( String.valueOf( getObject.get("info"))))
                {
                    case 1:
                        startActivity( new Intent( Fajian.this,
                                com.Fajian.zhongzhuan_main.class));
                        break;
                }
            }
        });
...
//        fajian_back.setOnClickListener(new View.OnClickListener() {
//            public void onClick(View v) {
//                showDialog(Fajian.this, "确认退出当前界面？");
//            }
//        });
    }

    public void fajian_back(View target)
    {
        Fajian.this.finish();
    }
...
//                        showDialog(Fajian.this, "还有未上传数据，请上传");
//                    else {
//                        dialog.dismiss();
//                        Fajian.this.finish();
//                    }
...
//    };
    private List<Map<String, Object>> getdbData()
    {
        ...
        db = openOrCreateDatabase("fajianlist.db",MODE_PRIVATE,null);
        //创建一个表
        ...
        db.execSQL("insert into userTb (name,number,addition) values ('汽运转航空[2]',2,'null')");
    ...
    public boolean onContextItemSelected(MenuItem aItem) {
        ...
        switch (aItem.getItemId()) {
            case 0:
                ...
                lv.invalidate();
                Toast.makeText(Fajian.this, "清空列表",Toast.LENGTH_SHORT).show();
                return true;
            case 1:
                map = new HashMap<String, Object>();
                map.put("image", R.mipmap.hong);
                ...
                adapter.notifyDataSetChanged();
                lv.invalidate();
                Toast.makeText(Fajian.this, "增加条码",Toast.LENGTH_SHORT).show();
                return true;
            case 2:
                data.remove(MID);
                adapter.notifyDataSetChanged();
                lv.invalidate();
                Toast.makeText(Fajian.this, "删除条码",Toast.LENGTH_SHORT).show();
                return true;
        }
        return false;
    }
